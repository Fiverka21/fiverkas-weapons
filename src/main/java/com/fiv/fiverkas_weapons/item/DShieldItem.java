...
public class DShieldItem extends ShieldItem {
    ...
    public static int getChargeCount(ItemStack stack) {
        return Math.round(stack.getOrDefault(DataComponents.CUSTOM_MODEL_DATA, CustomModelData.EMPTY).getFloat(0) == null
                ? 0.0F : stack.getOrDefault(DataComponents.CUSTOM_MODEL_DATA, CustomModelData.EMPTY).getFloat(0));
    }
